...
namespace IIS.InformacionnayaSistema
{
    ...
    public class ListComponent : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.InformacionnayaSistema.Component fComponent;
        ...
        [NotNull()]
        public virtual IIS.InformacionnayaSistema.Component Component
        {
            get
            {
                ...
                IIS.InformacionnayaSistema.Component result = this.fComponent;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ListComponentE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ListComponentE", typeof(IIS.InformacionnayaSistema.ListComponent));
                }
            }
        }
    }
    ...
    public class DetailArrayOfListComponent : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.InformacionnayaSistema.DetailArrayOfListComponent members)

        // *** End programmer edit section *** (IIS.InformacionnayaSistema.DetailArrayOfListComponent members)
        ...
        /// </summary>
        public DetailArrayOfListComponent(IIS.InformacionnayaSistema.Support fSupport) : 
                base(typeof(ListComponent), ((ICSSoft.STORMNET.DataObject)(fSupport)))
        {
        }
        
        public IIS.InformacionnayaSistema.ListComponent this[int index]
        {
            get
            {
                return ((IIS.InformacionnayaSistema.ListComponent)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.InformacionnayaSistema.ListComponent dataobject)
        {
