...
ALTER TABLE "ListSubindustry"
	ADD CONSTRAINT "ListSubindustry_FSubindustry_0" FOREIGN KEY ("Subindustry_m0") REFERENCES "Subindustry" ("primaryKey");

CREATE INDEX "ListSubindustry_ISubindus_1217" on "ListSubindustry" ("Subindustry_m0");

ALTER TABLE "ListSubindustry"
	ADD CONSTRAINT "ListSubindustry_FSupport_0" FOREIGN KEY ("Support_m0") REFERENCES "Support" ("primaryKey");

CREATE INDEX "ListSubindustry_ISupport_m0" on "ListSubindustry" ("Support_m0");

ALTER TABLE "ListInvestment"
	ADD CONSTRAINT "ListInvestment_FInvestment_0" FOREIGN KEY ("Investment_m0") REFERENCES "Investment" ("primaryKey");

CREATE INDEX "ListInvestment_IInvestment_m0" on "ListInvestment" ("Investment_m0");

ALTER TABLE "ListInvestment"
	ADD CONSTRAINT "ListInvestment_FSupport_0" FOREIGN KEY ("Support_m0") REFERENCES "Support" ("primaryKey");

CREATE INDEX "ListInvestment_ISupport_m0" on "ListInvestment" ("Support_m0");
