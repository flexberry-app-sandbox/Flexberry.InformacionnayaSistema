...
namespace IIS.Informacionnaya_sistema
{
    ...
    public class Support : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Informacionnaya_sistema.Form fForm;
        
        private IIS.Informacionnaya_sistema.DetailArrayOfListComponent fListComponent;
        
        private IIS.Informacionnaya_sistema.DetailArrayOfListInvestment fListInvestment;
        
        private IIS.Informacionnaya_sistema.DetailArrayOfListSize fListSize;
        
        private IIS.Informacionnaya_sistema.DetailArrayOfListSubindustry fListSubindustry;
        ...
        [NotNull()]
        public virtual IIS.Informacionnaya_sistema.Form Form
        {
            get
            {
                ...
                IIS.Informacionnaya_sistema.Form result = this.fForm;
        ...
        public virtual IIS.Informacionnaya_sistema.DetailArrayOfListComponent ListComponent
        {
            get
            {
                ...
                {
                    this.fListComponent = new IIS.Informacionnaya_sistema.DetailArrayOfListComponent(this);
                }
                IIS.Informacionnaya_sistema.DetailArrayOfListComponent result = this.fListComponent;
        ...
        public virtual IIS.Informacionnaya_sistema.DetailArrayOfListInvestment ListInvestment
        {
            get
            {
                ...
                {
                    this.fListInvestment = new IIS.Informacionnaya_sistema.DetailArrayOfListInvestment(this);
                }
                IIS.Informacionnaya_sistema.DetailArrayOfListInvestment result = this.fListInvestment;
        ...
        public virtual IIS.Informacionnaya_sistema.DetailArrayOfListSize ListSize
        {
            get
            {
                ...
                {
                    this.fListSize = new IIS.Informacionnaya_sistema.DetailArrayOfListSize(this);
                }
                IIS.Informacionnaya_sistema.DetailArrayOfListSize result = this.fListSize;
        ...
        public virtual IIS.Informacionnaya_sistema.DetailArrayOfListSubindustry ListSubindustry
        {
            get
            {
                ...
                {
                    this.fListSubindustry = new IIS.Informacionnaya_sistema.DetailArrayOfListSubindustry(this);
                }
                IIS.Informacionnaya_sistema.DetailArrayOfListSubindustry result = this.fListSubindustry;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View SupportE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("SupportE", typeof(IIS.Informacionnaya_sistema.Support));
                }
            }
            ...
            public static ICSSoft.STORMNET.View SupportL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("SupportL", typeof(IIS.Informacionnaya_sistema.Support));
                }
            }
        }
    }
