...
moduleForModel('i-i-s-informacionnaya-sistema-support', 'Unit | Serializer | i-i-s-informacionnaya-sistema-support', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-informacionnaya-sistema-support',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
