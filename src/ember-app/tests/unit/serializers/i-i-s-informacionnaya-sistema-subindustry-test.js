...
moduleForModel('i-i-s-informacionnaya-sistema-subindustry', 'Unit | Serializer | i-i-s-informacionnaya-sistema-subindustry', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-informacionnaya-sistema-subindustry',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
