...
moduleForModel('i-i-s-informacionnaya-sistema-list-subindustry', 'Unit | Serializer | i-i-s-informacionnaya-sistema-list-subindustry', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-informacionnaya-sistema-list-subindustry',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
