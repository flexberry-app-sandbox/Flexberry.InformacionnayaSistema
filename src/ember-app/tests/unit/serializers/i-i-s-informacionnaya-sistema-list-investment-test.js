...
moduleForModel('i-i-s-informacionnaya-sistema-list-investment', 'Unit | Serializer | i-i-s-informacionnaya-sistema-list-investment', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-informacionnaya-sistema-list-investment',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
