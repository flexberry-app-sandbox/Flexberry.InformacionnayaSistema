...
moduleForModel('i-i-s-informacionnaya-sistema-investment', 'Unit | Serializer | i-i-s-informacionnaya-sistema-investment', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-informacionnaya-sistema-investment',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
