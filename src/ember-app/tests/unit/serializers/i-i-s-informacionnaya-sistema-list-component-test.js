...
moduleForModel('i-i-s-informacionnaya-sistema-list-component', 'Unit | Serializer | i-i-s-informacionnaya-sistema-list-component', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-informacionnaya-sistema-list-component',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
