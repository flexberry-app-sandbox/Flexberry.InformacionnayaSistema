...
moduleForAcceptance('[AGAT] Acceptance | i i s informacionnaya sistema subindustry l');

test('testing i-i-s-informacionnaya-sistema-subindustry-l', function(assert) {
